 ...
 */
 #define RW_PIN   LATDbits.LATD2   		/* PORT for RW pin 5 on LCD*/
 #define TRIS_RW  TRISDbits.TRISD2   	/* TRIS for RW */

 #define RS_PIN   LATDbits.LATD1   		/* PORT for RS pin 4 on LCD*/
 #define TRIS_RS  TRISDbits.TRISD1    	/* TRIS for RS */

 #define E_PIN    LATDbits.LATD0  		/* PORT for E  pin 6 on LCD*/
