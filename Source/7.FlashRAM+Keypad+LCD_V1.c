...
{
    sprintf(lcdVariable, "Heart Rate = %d", sramRead(ptr << 12));
    ...
    sprintf(lcdVariable,"Glucose Lvl = %d", sramRead((ptr + 32) << 12));
...
void initSecErase()
{
    ...
    */
   short long i;
   for(i = 4096; i<=520192; i+=4096)
   {
       sramSecErase(i);
       sramByteProgramOp(i,0b00001100);
       sprintf (lcdVariable,"A= %lu, D= %d", i, sramRead(i));
       print();
       Delay10KTCYx(500);
   }
