...
char softIDadd[6] = {0x55,0x55,0x2A,0xAA,0x55,0x55};
char softIDdat[3] = {0xAA,0x55,0x90};
char SectorEraseADD[12] ={0x55,0x55,0x2A,0xAA,0x55,0x55,0x55,0x55,0x2A,0xAA,0x01,0x00};
char SectorEraseDAT[6] = {0xAA, 0x55, 0x80, 0xAA,0x55, 0x30};
