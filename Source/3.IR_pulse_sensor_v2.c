/*This version of the pulse rate monitor has a continuous pulse interval of 15s
 ...
 number of pulse events to be displayed on the screen. It differs from IR_pulse_sensor_v1
 such that the sensor is now integrated with the lCD for testing purposes*/
...
bool isCounting = 0;                                    //state that defines whether the program is currently counting pulses or not
